...
An oil heater cycle is modeled by MATLAB/Simulink as the graduation project for Boğaziçi University's **ME 492** class.
...
---
The diagram that represents the oil cycle is provided below:
<p align="center">
  <img src="https://github.com/edizferit/Oil_Heater_Simulation/blob/main/figures/cycle_v2.png?raw=true" width="30%">
</p>
---
The default control strategy applied at the heater to keep the oil at the desired temperature is given below:
<p align="center">
  <img src="https://github.com/edizferit/Oil_Heater_Simulation/blob/main/figures/control_strategy.png?raw=true" width="40%">
</p>
---
